package com.example.lcj.badcode.repeatcode;
...
import com.example.lcj.badcode.repeatcode.good.*;
...
public class BankService {
    ...
    public static String createUser(String name, String identity, String mobile, int age) throws IOException {
        ...
        stringBuilder.append(DigestUtils.md5Digest(stringBuilder.toString().getBytes()));
    ...
    public static String pay(long userId, BigDecimal amount) throws IOException {
        ...
        stringBuilder.append(String.format("%010d",
                amount.setScale(2, RoundingMode.DOWN).multiply(new BigDecimal("100")).longValue()));

        // 最后加上MD5作为签名

        stringBuilder.append(DigestUtils.md5Digest(stringBuilder.toString().getBytes()));

        // return Request.Post("http://localhost:45678/returneflection/bank/pay")
        //
        // .bodyString(stringBuilder.toString(), ContentType.APPLICATION_JSON)
        //
        // .execute().returnContent().asString();
    ...
    public static String pay1(long userId, BigDecimal amount) throws IOException {
                ...
                .forEach(field -> {
                    ...
                    switch (bankAPIField.type()) {
                        ...
                        case "S": {
                            ...
                            stringBuilder.append(String.format("%-" + bankAPIField.length() + "s", value.toString())
                                    .replace(' ', '_'));
