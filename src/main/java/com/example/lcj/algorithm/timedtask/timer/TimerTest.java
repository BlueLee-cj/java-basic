package com.example.lcj.algorithm.timedtask.timer;
 ...
 * 如果是周期性任务，执行完成后重新计算下一次任务的 deadline，并再次放入小根堆；如果是单次执行的任务，执行结束后会从 TaskQueue 中删除。
 *
 * @author lichengjian
 * @date 2022/2/13
 */
public class TimerTest {
    public static void main(String[] args) {
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            @Override
            public void run() {
                System.out.println("timer do " + System.currentTimeMillis());
            }
